...
function getAccount(config) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = generateAccountUrl({ accountId: config.accountId });
                ...
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, response.data.map(function (d) { return d.securitiesAccount; })];
            }
        });
    });
}
exports.getAccount = getAccount;
function generateAccountUrl(_a) {
    var accountId = _a.accountId;
    var accountUIdUrlString = accountId ? '/' + accountId : '';
    return "".concat(routes_config_1.ACCOUNTS).concat(accountUIdUrlString);
}
