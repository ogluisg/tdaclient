...
exports.oauth = exports.AccessType = exports.GrantType = void 0;
 ...
 */
function oauth(oAuthData) {
    return __awaiter(this, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client_1["default"].post({
                        url: routes_config_1.OAUTH2_TOKEN,
                        data: oAuthData,
                        responseType: connect_1.ResponseType.URL_FORM_ENCODED,
